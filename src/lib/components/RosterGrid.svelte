...
<div class="hidden md:block" style="overflow: hidden; padding: 48px 0;">
	<div style="display: flex; flex-direction: column; align-items: center; gap: 16px; width: max-content; position: relative; left: 50%; transform: translateX(-50%);">
		...
		<div style="width: 55px; flex-shrink: 0; overflow: hidden;
			-webkit-mask-image: linear-gradient(to right, transparent 0%, black 5%), linear-gradient(to bottom, transparent 0%, black 5%); -webkit-mask-composite: destination-in;
			mask-image: linear-gradient(to right, transparent 0%, black 5%), linear-gradient(to bottom, transparent 0%, black 5%); mask-composite: intersect;">
			<div style="width: 220px; margin-left: -165px; display: flex; align-items: flex-end; overflow: hidden;">
				<div style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girls[11].bg}; position: relative; margin-top: -50%;">
		...
		<div style="width: 220px; flex-shrink: 0; overflow: hidden; display: flex; align-items: flex-end;
			...
			<div class="roster-card" style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girl.bg}; position: relative; margin-top: -50%;">
		...
		<div style="width: 55px; flex-shrink: 0; overflow: hidden;
			-webkit-mask-image: linear-gradient(to right, black 95%, transparent 100%), linear-gradient(to bottom, transparent 0%, black 5%); -webkit-mask-composite: destination-in;
			mask-image: linear-gradient(to right, black 95%, transparent 100%), linear-gradient(to bottom, transparent 0%, black 5%); mask-composite: intersect;">
			<div style="width: 220px; display: flex; align-items: flex-end; overflow: hidden;">
				<div style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girls[8].bg}; position: relative; margin-top: -50%;">
		...
		<!-- Left wing (show right 1/4) -->
		<div style="width: 55px; flex-shrink: 0; overflow: hidden;
			-webkit-mask-image: linear-gradient(to right, transparent 0%, black 5%), linear-gradient(to bottom, black 95%, transparent 100%); -webkit-mask-composite: destination-in;
			mask-image: linear-gradient(to right, transparent 0%, black 5%), linear-gradient(to bottom, black 95%, transparent 100%); mask-composite: intersect;">
			<div style="width: 220px; margin-left: -165px; display: flex; align-items: flex-start; overflow: hidden;">
				<div style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girls[7].bg}; position: relative; margin-bottom: -50%;">
		...
		<div style="width: 220px; flex-shrink: 0; overflow: hidden; display: flex; align-items: flex-start;
			...
			<div class="roster-card" style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girl.bg}; position: relative; margin-bottom: -50%;">
				{#if girl.img}<img src={girl.img} alt={girl.name} style="width: 102%; height: 102%; object-fit: cover; position: absolute; top: -1%; left: -1%;" />{/if}
			</div>
		</div>
		{/each}
		<!-- Right wing (show left 1/4) -->
		<div style="width: 55px; flex-shrink: 0; overflow: hidden;
			-webkit-mask-image: linear-gradient(to right, black 95%, transparent 100%), linear-gradient(to bottom, black 95%, transparent 100%); -webkit-mask-composite: destination-in;
			mask-image: linear-gradient(to right, black 95%, transparent 100%), linear-gradient(to bottom, black 95%, transparent 100%); mask-composite: intersect;">
			<div style="width: 220px; display: flex; align-items: flex-start; overflow: hidden;">
				<div style="aspect-ratio: 9/16; width: 100%; border-radius: 24px; overflow: hidden; background: {girls[4].bg}; position: relative; margin-bottom: -50%;">
